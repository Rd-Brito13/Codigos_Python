...
A_pedir = [1000 if quantidade < 200 else 500 for produto, quantidade in estoque]
#Retorna uma lista com os o tamanho dos pedidos a cada produto do estoque
A_pedir_Produto = [produtos for produtos, quantidade in estoque]
#Desempacota somente os códigos dos produtos 
Lista_Final = dict(zip(A_pedir_Produto, A_pedir))
print(Lista_Final)
#Zipa o valor a ser pedido de cada produto, e os produtos e imprime na tela.
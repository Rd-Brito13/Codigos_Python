...
def estoque(*listas_vendas):
    estoque_produto = []
    for lista_venda in listas_vendas:
        for produto, estoque in lista_venda:
            estoque_produto.append(produto)
            estoque_produto = set(estoque_produto)
            estoque_produto = list(estoque_produto)
    return estoque_produto
print(estoque(estoque_fim_jan, estoque_fim_fev, estoque_fim_mar,estoque_fim_abr))

input("infomre o valor: ")
